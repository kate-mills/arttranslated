...
const SymbolismVideoPage = () => {
  return (
    <Layout showFooter={false}>
      <Seo title="Art Translated Privacy Policy" />
      ...
      <div id="privacy-policy">
        ...
        <p>
          {' '}
          Art Translated (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by Art Translated.
        </p>
        <p>
          ...
          Art Translated. By accessing or using our Service, you signify that
        ...
        <ul>
          ...
          <li>
            ...
            it refers to Art Translated, that is responsible for your
            information under this Privacy Policy.
          </li>
          <li>
            Country: where Art Translated or the owners/founders of Art
            Translated are based, in this case is United States
          </li>
          <li>
            Customer:&nbsp;refers to the company, organization or person that
            signs up to use the Art Translated Service to manage the
            relationships with your consumers or service users.
          </li>
          <li>
            Device:&nbsp;any internet connected device such as a phone, tablet,
            computer or any other device that can be used to visit Art
            Translated and use the services.
          </li>
          <li>
          ...
          <li>
            Personnel:&nbsp;refers to those individuals who are employed by Art
            Translated or are under contract to perform a service on behalf of
            one of the parties.
          </li>
          <li>
          ...
          <li>
            Service: refers to the service provided by Art Translated as
          ...
          <li>
            Website: Art Translated's site, which can be accessed via this URL:{' '}
          </li>
          <li>
            You: a person or entity that is registered with Art Translated to
            use the Services.
          </li>
        </ul>
        <p></p>
        ...
        <p>
          ...
          of the assets of Art Translated or any of its Corporate Affiliates (as
          defined herein), or that portion of Art Translated or any of its
        ...
        <p>
          ...
          Art Translated, whether by ownership or otherwise. Any information
        ...
        <p>
          By using Art Translated or contacting us directly, you signify your
        ...
        <p>
          ...
          and how it's being used. By using our app, registering an account, or
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by Art
          Translated. We are not responsible for the content, accuracy or
        ...
        <h1>Cookies</h1>
        <p>
          Art Translated uses "Cookies" to identify the areas of our website
        ...
        <p>
          You acknowledge and agree that Art Translated shall not be responsible
          ...
          or any other aspect thereof. Art Translated does not assume and shall
        ...
        <p>
          ...
          right thing to do. At Art Translated we strongly believe that your
        ...
        <p>
          ...
          rights requirements of GDPR. Art Translated processes or stores all
        ...
        <ul>
          <li>
            Via Email:{' '}
            <a href={`mailto:info.arttranslated@gmail.com`}>
